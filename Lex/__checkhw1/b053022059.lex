...
void nostring1(char *yytext,int lineCount,int charCount)
{
	...
	printf("\033[40;31;5mError :\033[0m\n"); 
	printf("\033[40;31mstring-(5-1) : You couldnt forget to set (') afterhand the string what you tpye in .\033[0m\n ");
	lineCount++;charCount = 1;
}
void nostring2(char *yytext,int lineCount,int charCount)
{
	...
	printf("\033[40;31;5mError :\033[0m\n"); 
	printf("\033[40;31mstring-(5-2) : You couldnt forget to set (') beforehand the string what you tpye in .\033[0m\n ");
	lineCount++;charCount = 1;
}
...
void small(char *yytext,int lineCount,int charCount)
{
	...
	if( s[0] == '0')
	{
		if( s[1] != '.')
			...
			printf("\033[40;31;5mError :\033[0m\n"); 
			printf("\033[40;31mreal wrong : (1) : You should set (.) after the 0.\033[0m\n");	
			}	
	}
	/*
	...
	*/
	...
	{	
		if( s[str_l-2]== '0' && s[str_l-1]== '0' )
			...
			printf("Line: %d, 1st char: %d, \"%s\" is a invalid \"real(small)\".\n",lineCount,charCount,yytext);
			printf("\033[40;31;5mError :\033[0m\n"); 
			printf("\033[40;31mreal wrong : (2) : You shouldnt set double 0 at the lastest 2 digits. \033[0m\n");
			}
	}
		...
		printf("Line: %d, 1st char: %d, \"%s\" is a invalid \"real(small)\".\n",lineCount,charCount,yytext);
		printf("\033[40;31;5mError :\033[0m\n"); 
		printf("\033[40;31mreal wrong : (3) : You should set (.). \033[0m\n");
		}
	else if( s[0] == '.')
		{
		printf("Line: %d, 1st char: %d, \"%s\" is a invalid \"real(small)\".\n",lineCount,charCount,yytext);
		printf("\033[40;31;5mError :\033[0m\n"); 
		printf("\033[40;31mreal wrong : (4) : You should set digit before the (.) at least. \033[0m\n");
		}
	else
	printf("Line: %d, 1st char: %d, \"%s\" is a \"real(small)\".\n",lineCount,charCount,yytext);
	lineCount++;charCount = 1;
...
void no_small2(char *yytext,int lineCount,int charCount)
{
	...
	printf("\033[40;31;5mError :\033[0m\n"); 
	printf("\033[40;31mreal wrong (5) : You should put integer beforehand the dot(.) .\033[0m\n");
	lineCount++;charCount = 1;
}
void no_small3(char *yytext,int lineCount,int charCount)
{
	...
	printf("\033[40;31;5mError :\033[0m\n"); 
	printf("\033[40;31mreal wrong (6) : You should put integer afterhand the dot(.) .\033[0m\n");
	lineCount++;charCount = 1;
}
...
void symint(char *yytext,int lineCount,int charCount)
{
	...
	for(i=0;i<str_l;i++)	
		...
		if(yytext[i] == '+' || yytext[i] == '-')
			...
			printf("Line: %d, 1st char: %d, \"%c\" is a \"symbol(symint)\".\n",lineCount,charCount,yytext[i]);
			charCount++;
			printf("Line: %d, 1st char: %d, \"",lineCount,charCount);
			}
		else			
